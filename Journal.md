uh i kinda feel like coding 2048 i guess - here's the journal (originally was gonna be 2 weeks but idk it's kinda fun and an opportunity to make actually nice code for once)
...
## day 9
- oh the chores begin - i have begun refactoring in line with refactoring guru's recommendations. so far i have just moved large chunks out of the main loop, i still would like to change which parts of those are parameters though (it may be worth making a separate GridRenderer class for that, and perhaps a separate file)
- i also made a new file for this stuff (effectively journal) so the README can actually serve its purpose